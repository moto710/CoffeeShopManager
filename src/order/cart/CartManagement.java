...
//        List<Cart> showOldOrderUsers = new ArrayList<>();
//        List<String> lines = ReadWriteFile.read(CART_LIST_PATH.getPath());
//        for (String line : lines) {
//            showOldOrderUsers.add(Cart.ParseShowOldOrderUser(line));
//        }
...
//        List<Cart> showOldOrderUserList = new ArrayList<>();
//        ReadWriteFile.write(CART_LIST_PATH.getPath(),showOldOrderUserList);
//        Long idOldCustomer;
...
//                    Cart newShowOldOrderUser = new Cart(idOldCustomer,nameoldCustomer,oldPhone,oldAddress,oldIdItem,oldNameFood,oldPrice,oldQuantity,oldtotal,oldcreateAt);
...
//        List<Cart> showOldOrderUserList = findAll();
//        Double totalOldOrderPirce = Double.valueOf(0);
//        for (Cart showOldOrderUser : showOldOrderUserList) {
