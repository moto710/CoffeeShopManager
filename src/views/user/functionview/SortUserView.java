...
import views.user.view.functionview.allsortview.*;
...
public class SortUserView extends UserTemplate {
    ...
    public void menuSort(){
        ...
        System.out.println("3. Sort by views.user name with ascending:");
        System.out.println("4. Sort by views.user name with descending:");
