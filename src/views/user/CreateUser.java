...
public class CreateUser {
    ...
    public CreateUser(String username, String password, String fullName, String phone, String email, String address, String role) {
    ...
    public CreateUser(String username, String password, String fullName, String phone, String email, String address, String role, Instant createdAt) {
        this.id = System.currentTimeMillis() / 1000000;
        this.username = username;
        this.password = password;
        this.fullName = fullName;
